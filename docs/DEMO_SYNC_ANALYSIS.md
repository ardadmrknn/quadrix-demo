...
| `src/game_modes_extra.py` (satır ~463+) | `get_card_selection_bucket()` + `_should_trigger_demo_score_cap()` | Kart seçimi 10 level'de bir; 100K skor cap |
