...
SCENARIOS: Dict[str, Dict[str, Any]] = {
    ...
    "hold_save_practice": {
        ...
        "objectives": [
            {"id": "used_hold", "text": "Hold kullan", "metric": "line_delta", "comparison": "min", "value": 0},
    ...
    "recovery_breathing_room": {
        ...
        "next_queue": ["I", "L", "O"],
        "allow_hold": False,
        "goal_text": "Hedef: En az 1 satır temizle ve tahtayı daha kötü yapma.",
        "tip_key": "tutorial_recovery_breathing_tip",
        "tip_text": "Skor düşünme — önce nefes al, sonra plan yap.",
        "objectives": [
            {"id": "clear_lines", "text": "En az 1 satır temizle", "metric": "line_delta", "comparison": "min", "value": 1},
            {"id": "avoid_holes", "text": "Yeni delik sayısını artırma", "metric": "hole_delta", "comparison": "max", "value": 0},
        ],
        "coach_feedback": {
            "clean": "Panik yapmadan önce alan açtın — nefes alan hayatta kalır.",
            "need_more_lines": "Kötü board'da öncelik: bir satır bile temizlemek nefes açar.",
            "created_holes": "Kurtarma modunda yeni delik açmak durumu kötüleştirir.",
            "stack_too_high": "Önceliğin yüksekliği kontrol altına almak — satır temizle.",
        },
        "evaluation": {
            "required_line_clears": 1,
            "max_new_holes": 0,
    ...
    "recovery_hole_vs_height": {
        ...
        "next_queue": ["T", "L", "I"],
        "allow_hold": False,
        "goal_text": "Hedef: Doğru önceliğe odaklan — delik mi, yükseklik mi?",
        "tip_key": "tutorial_recovery_hole_height_tip",
        "tip_text": "Genellikle delik kapatmak, tepe düşürmekten daha acildir.",
        "objectives": [
            {"id": "reduce_holes", "text": "Delik sayısını azalt veya koru", "metric": "hole_delta", "comparison": "max", "value": 0},
            {"id": "height_control", "text": "Yüksekliği artırma", "metric": "height_delta", "comparison": "max", "value": 1},
        ],
        "coach_feedback": {
            "clean": "Doğru önceliği seçtin — delik kapatmak genelde daha acildir.",
            "need_more_lines": "Bu derste satır temizlemek zorunlu değil; delikleri azaltmak yeterli.",
    ...
    "recovery_reduce_ceiling": {
        ...
        "next_queue": ["T", "O", "L"],
        "allow_hold": False,
        "goal_text": "Hedef: Yüksekliği en az 2 birim düşür.",
        "tip_key": "tutorial_recovery_ceiling_tip",
        "tip_text": "Güvenli tarafı kullan, satır temizlemeye odaklan.",
        "objectives": [
            {"id": "reduce_height", "text": "Yüksekliği en az 2 azalt", "metric": "height_delta", "comparison": "max", "value": -2},
            {"id": "avoid_holes", "text": "Yeni delik oluşturma", "metric": "hole_delta", "comparison": "max", "value": 0},
        ],
        "coach_feedback": {
            "clean": "Tavanı başarıyla düşürdün — her satır temizleme nefes alanı açar.",
            "need_more_lines": "Önceliğin satır temizlemek — her temizlenen satır tavanı düşürür.",
            "created_holes": "Tavanı düşürürken yeni delik açma — sorun büyür.",
            "stack_too_high": "I parçasını düz kullanarak satır temizle, tavanı indir.",
        },
        "evaluation": {
            "required_line_clears": 2,
            "max_new_holes": 0,
    ...
    "recovery_wrong_side": {
        ...
        "next_queue": ["T", "I", "O"],
        "allow_hold": False,
        "goal_text": "Hedef: Dengesiz tahtayı düzelt.",
        "tip_key": "tutorial_recovery_wrong_side_tip",
        "tip_text": "Boş tarafı doldurma — yüksek tarafı indir.",
        "objectives": [
            {"id": "clear_lines", "text": "En az 1 satır temizle", "metric": "line_delta", "comparison": "min", "value": 1},
            {"id": "avoid_holes", "text": "Yeni delik oluşturma", "metric": "hole_delta", "comparison": "max", "value": 0},
        ],
        "coach_feedback": {
            "clean": "Dengesiz tahtayı düzelttin — yüksek tarafı indirmek doğru öncelik.",
            "need_more_lines": "Yüksek taraftaki satırları temizlemeye odaklan.",
            "created_holes": "Dengeyi düzeltirken yeni delik açma — sorun büyür.",
            "stack_too_high": "Boş tarafa koymak yerine dolu tarafı azaltmaya çalış.",
        },
        "evaluation": {
            "required_line_clears": 1,
            "max_new_holes": 0,
    ...
    "exam_hybrid_final": {
        ...
        "objectives": [
            ...
            {"id": "avoid_holes", "text": "Yeni delik oluşturma", "metric": "hole_delta", "comparison": "max", "value": 0},
            {"id": "reduce_height", "text": "Yüksekliği azalt", "metric": "height_delta", "comparison": "max", "value": 0},
        ],
        "coach_feedback": {
            "clean": "Tüm ilkeleri birleştirdin — tebrikler, eğitimi tamamladın!",
            "need_more_lines": "Her şeyi birleştir — yüzey, queue, hold, kurtarma.",
            "created_holes": "Final sınavında delik açmak kabul edilemez — ilkeleri tekrar gözden geçir.",
