...
TRANSLATIONS = {
    ...
    'menu_dashboard_sub_piece_workshop': {
        'tr': 'Özel parçaları üret ve kaydet',
        'en': 'Build and save custom pieces',
        'de': 'Erstelle und speichere eigene Teile',
        'fr': 'Crée et enregistre des pièces personnalisées',
        'es': 'Crea y guarda piezas personalizadas',
        'it': 'Crea e salva pezzi personalizzati',
        'pt': 'Crie e salve peças personalizadas',
        'ru': 'Создавайте и сохраняйте фигуры',
        'ja': 'カスタムピースを作成して保存',
        'zh': '创建并保存自定义方块',
        'ko': '커스텀 조각을 만들고 저장하세요',
    },
    ...
    'menu_dashboard_sub_block_styles': {
        'tr': 'Bloklarını tema ve stille özelleştir',
        'en': 'Customize block theme and style',
        'de': 'Passe Block-Thema und Stil an',
        'fr': 'Personnalise le thème et le style des blocs',
        'es': 'Personaliza el tema y estilo de bloques',
        'it': 'Personalizza tema e stile dei blocchi',
        'pt': 'Personalize tema e estilo dos blocos',
        'ru': 'Настройте тему и стиль блоков',
        'ja': 'ブロックのテーマとスタイルをカスタマイズ',
        'zh': '自定义方块主题与风格',
        'ko': '블록 테마와 스타일을 꾸미세요',
    },
