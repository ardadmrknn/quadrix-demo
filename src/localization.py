...
TRANSLATIONS = {
    ...
    'card_score_desc': {
        ...
        'ru': 'Instantly gain +{value} points.',
        'ja': '即座に+{value}ポイント獲得。',
        'zh': '立即获得 +{value} 分。',
        'ko': '즉시 +{value}점 획득.',
    },
    ...
    'card_speed_burst_desc': {
        ...
        'ru': '50% faster drop for {value} seconds + 2x points for every cleared line!',
    ...
    'card_time_capsule_desc': {
        ...
        'ru': 'Use time capsule with R: first press saves, second press restores.',
    ...
    'card_clear_rows_desc': {
        ...
        'ru': 'Clears the bottom {value} rows. Blocks settle down.',
    ...
    'card_block_magnet_desc': {
        ...
        'ru': 'All gaps close! Blocks stick together and gaps disappear.',
    ...
    'card_perk_flexible_border_desc': {
        ...
        'ru': 'PERK: Pieces can extend 1 block beyond the board edges.',
    ...
    'card_column_cleanse_desc': {
        ...
        'ru': 'Completely clears {value} random columns.',
    ...
    'card_force_piece_desc': {
        ...
        'ru': 'Next {value} pieces will be I, T, or L shaped.',
    ...
    'card_combo_boost_desc': {
        ...
        'ru': 'Combo will not reset for {value} seconds.',
    ...
    'card_time_slow_desc': {
        ...
        'ru': 'Pieces fall 50% slower for {value} seconds.',
    ...
    'card_line_bonus_desc': {
        ...
        'ru': '2x points for the next {value} line clears.',
    ...
    'card_peak_sculpt_desc': {
        ...
        'ru': 'Cuts the highest {value} blocks, flattening the board.',
    ...
    'card_nova_burst_desc': {
        ...
        'ru': 'Next {value} locks will explode a 3x3 area at center.',
    ...
    'card_mini_bomb_desc': {
        ...
        'ru': 'When locked, explodes its own cells + touching neighbor blocks.',
    ...
    'card_quantum_tunneling_desc': {
        ...
        'ru': '3 uses: Press G to make a piece ghost; passes through blocks.',
    ...
    'card_hammer_desc': {
        ...
        'ru': '3 uses: Press H to instantly turn the falling piece into a 1x1 block.',
    ...
    'card_bomb_master_desc': {
        ...
        'ru': '3 uses: Press M to turn the current piece into a mini bomb. On lock, it explodes the blocks it touches.',
    ...
    'card_perk_explosive_desc': {
        ...
        'ru': 'PERK: After clearing 2 lines, next piece becomes a bomb; explodes + shaped (5 cells) on lock.',
    ...
    'card_rewind_power_desc': {
        ...
        'ru': 'PERK: Press U to undo the last piece (3 uses).',
    ...
    'card_perk_chrono_desc': {
        ...
        'ru': 'PERK: Every 10 lines, gravity stops for 3 seconds.',
    ...
    'card_perk_phase_desc': {
        ...
        'ru': 'Press LSHIFT to transform piece to its mirror (L↔J, Z↔S). (3 uses)',
    ...
    'card_perk_synergy_desc': {
        ...
        'ru': 'PERK: +10% score bonus for each active perk.',
    ...
    'card_perk_second_pocket_desc': {
        ...
        'ru': 'PERK: Press V to store a second piece.',
    ...
    'card_perk_alchemist_desc': {
        ...
        'ru': 'PERK: Clearing 4 lines (Quadrix) turns random blocks to gold.',
    ...
    'card_gravity_well_desc': {
        ...
        'ru': 'Blocks collapse down, all filled rows are cleared.',
    ...
    'card_ghost_echo_desc': {
        ...
        'ru': 'Resurrection: When game would end, clears top half and you continue.',
    ...
    'card_row_shuffle_desc': {
        ...
        'ru': 'Shuffles blocks in the bottom {value} rows, try your luck!',
    ...
    'card_laser_drill_desc': {
        ...
        'ru': 'Current piece melts blocks in its path while falling.',
        'ja': '落下中、進路のブロックを溶かす。',
        'zh': '下落时融化路径上的方块。',
    ...
    'card_sniper_shot_desc': {
        ...
        'ru': '3 uses: Click any block on the board to explode it.',
    ...
    'card_future_changer_desc': {
        ...
        'ru': 'Choose the next 2 pieces yourself! A popup opens and you select the pieces you want.',
    ...
    'extras_classic_desc': {
        ...
        'ru': 'The classic Quadrix everyone knows.',
        'ja': '誰もが知るクラシック。',
        'zh': '人人皆知的经典。',
        'ko': '모두가 아는 클래식. ',
    },
    'extras_sprint_desc': {
        ...
        'ru': 'Clear 40 lines as fast as possible.',
        'ja': '40ラインを最速で消そう。',
        'zh': '以最快速度清除40行。',
        'ko': '40줄을 최대한 빨리 지우세요.',
    },
    ...
    'mode_intro_survival_desc': {
        ...
        'ru': 'Viruses invade and spread on the board.\nClear lines to charge the antivirus and survive.',
    ...
    'mode_intro_mystery_desc': {
        ...
        'ru': 'A new dimension for Quadrix.\nUse special cards to manipulate the game.',
        'ja': 'テトリスに新次元。\n特殊カードでゲームを操ろう。',
        'zh': '为俄罗斯方块带来新维度。\n用特殊卡牌操控游戏。',
        'ko': '테트리스에 새로운 차원.\n특수 카드로 게임을 조작하세요.',
    },
    ...
    'mode_intro_hardcore_desc': {
        ...
        'ru': 'Next pieces hidden, no hold, inverted controls.\nOnly for true masters!',
    ...
    'extras_zen_desc': {
        ...
        'ru': 'No stress, no time limit. Play relaxed.',
    ...
    'extras_tetris2_desc': {
        ...
        'ru': 'New combinations with extra pieces.',
        'ja': '追加ピースで新しいコンボ。',
        'zh': '用额外方块的新组合。',
        'ko': '추가 피스로 새로운 조합.',
    },
    ...
    'extras_survival_desc': {
        ...
        'ru': 'Pressure rises, mistakes are costly',
        'ja': 'プレッシャー増大、ミスは致命的。',
        'zh': '压力上升，失误代价高',
        'ko': '압박이 올라가고 실수는 치명적',
    },
    ...
    'guide_mode_campaign': {
        ...
        'ru': '• Campaign Mode: 100-level adventure. Complete objectives and earn stars.',
    ...
    'guide_mode_classic': {
        ...
        'ru': '• Classic Mode: Endless mode. Play as long as you can and achieve high scores.',
    ...
    'guide_mode_sprint': {
        ...
        'ru': '• Sprint: Clear 40 lines as fast as possible. It\'s a race against time!',
    ...
    'guide_mode_ultra': {
        ...
        'ru': '• Ultra: Score as high as possible within 3 minutes.',
    ...
    'guide_mode_zen': {
        ...
        'ru': '• Zen: Stress-free endless play. No game over, just relaxation.',
    ...
    'guide_mode_survival': {
        ...
        'ru': '• Survival: Difficulty constantly increases. How long can you last?',
    ...
    'guide_mode_cascade': {
        ...
        'ru': '• Cascade: After placement, blocks fall down creating chain reactions.',
    ...
    'guide_mode_tetris2': {
        ...
        'ru': '• Quadrix Extra: 4 new piece types (P, Q, U, Plus) in addition to 7 classic pieces.',
    ...
    'guide_mode_wide': {
        ...
        'ru': '• Wide Mode: Board width is 20 blocks. More space, more strategy!',
    ...
    'guide_mode_mystery': {
        ...
        'ru': '• Card Mastery (Mystery): Use special cards to gain tactical advantages!',
    ...
    'guide_mode_pvp': {
        ...
        'ru': '• PvP: 2 players compete side by side. Lines you clear send garbage to opponent!',
    ...
    'guide_mode_daily': {
        ...
        'ru': '• Daily Challenge: New goals and rewards every day!',
    ...
    'guide_mode_hardcore': {
        ...
        'ru': '• Hardcore: Inverted controls, hidden info, and high risk. Only for masters!',
    ...
    'guide_card_clear_rows_desc': {
        ...
        'ru': 'Instantly clears the bottom 1-3 rows. Blocks settle down and you earn score.',
    ...
    'guide_card_peak_sculpt_desc': {
        ...
        'ru': 'Cuts the top 2-4 blocks and flattens the board. Ideal for clearing congestion.',
    ...
    'guide_card_row_shuffle_desc': {
        ...
        'ru': 'Randomly shuffles blocks in the bottom 2-4 rows. Try your luck - sometimes gaps close!',
    ...
    'guide_card_mini_bomb_desc': {
        ...
        'ru': 'When the current piece locks, it explodes its own cells and touching neighbor blocks.',
    ...
    'guide_card_quantum_desc': {
        ...
        'ru': '3 uses: Press G to make piece ghost - it can pass through blocks!',
    ...
    'guide_card_hammer_desc': {
        ...
        'ru': '3 uses: Press H to instantly transform current piece into a 1x1 block.',
    ...
    'guide_card_laser_desc': {
        ...
        'ru': 'Current piece melts blocks in its path while falling. Perfect for opening clogged areas!',
    ...
    'guide_card_sniper_desc': {
        ...
        'ru': '3 uses: Click on any block on the board to explode it.',
        'ja': '3回: 盤面の任意のブロックをクリックして爆破。',
    ...
    'guide_card_nova_desc': {
        ...
        'ru': 'Next 2-4 locks explode a 3x3 area at piece center. Powerful cleaning!',
    ...
    'guide_card_gravity_desc': {
        ...
        'ru': 'All blocks fall down, gaps close. Any complete rows are automatically cleared.',
    ...
    'guide_card_phase_desc': {
        ...
        'ru': '3 uses: Press LSHIFT to swap piece to its mirror (L↔J, Z↔S). Strategic flexibility!',
    ...
    'guide_card_pocket_desc': {
        ...
        'ru': 'PERK: Press V to hold a second piece. More strategic options!',
    ...
    'guide_card_magnet_desc': {
        ...
        'ru': 'Legendary! All gaps close - blocks stick together. Board instantly flattens.',
    ...
    'guide_card_ghost_desc': {
        ...
        'ru': 'Legendary! Death save: When game would end, clears top half and you continue.',
    ...
    'guide_perk_synergy_desc': {
        ...
        'ru': 'Permanent PERK: +10% score bonus for each active perk. Collect perks, grow bonus!',
    ...
    'guide_perk_explosive_desc': {
        ...
        'ru': '3 uses: Press M to make current piece a mini bomb. Explodes surroundings when locked.',
    ...
    'guide_perk_chrono_desc': {
        ...
        'ru': 'Permanent PERK: Piece fall speed slows by 15%. More time to think!',
    ...
    'guide_perk_cushion_desc': {
        ...
        'ru': 'Permanent PERK: Piece lock delay is 2× longer. More time to adjust placement!',
    ...
    'guide_perk_rewind_desc': {
        ...
        'ru': '1 use: Press R to undo last move. Fix mistakes!',
    ...
    'guide_card_future_desc': {
        ...
        'ru': 'Rare! Lets you choose the next 2 pieces. Perfect for strategic planning!',
    ...
    'guide_card_speed_burst_desc': {
        ...
        'ru': 'Timed: 50% faster drop and 2x points for every line!',
    ...
    'guide_card_flexible_border_desc': {
        ...
        'ru': 'PERK: Pieces can move 1 block outside the board borders.',
    ...
    'guide_card_time_capsule_desc': {
        ...
        'ru': 'Use with R: first press saves, second press restores.',
        'ja': 'Tで盤面を保存し、Rで戻る。',
    ...
    'card_hold_destroyer_desc': {
        ...
        'ru': '{value} use(s): Power to discard held piece! Press B to use.',
    ...
    'card_color_cleanse_desc': {
        ...
        'ru': 'Clears all blocks of a random color. Upper blocks fall down.',
    ...
    'card_gambler_dice_desc': {
        ...
        'ru': 'Roll the dice! 50% chance to clear the entire board or fill half with random blocks.',
    ...
    'card_block_workshop_card_desc': {
        ...
        'ru': 'Opens a workshop popup where you create a custom piece with up to 7 blocks!',
