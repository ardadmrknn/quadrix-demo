...
TRANSLATIONS = {
    ...
    'card_reroll_selection': {
        'tr': 'Yeniden Çek', 'en': 'Reroll', 'de': 'Neu würfeln', 'fr': 'Relancer', 'es': 'Volver a tirar', 'it': 'Rilancia', 'pt': 'Retirar', 'ja': '引き直し', 'zh': '重新抽取', 'ko': '다시 뽑기'
    },
    'card_choose': {
...
# =====================================================================
# RUSÇA (RU) — Gerçek Rusça çeviriler (kaynak override)
# _ensure_language_fallback sonrası çalışır; EN fallback'i geçersiz kılar
# =====================================================================
_RU_TRANSLATIONS = {
    # ANA MENÜ
    'main_menu_title': 'QUADRIX',
    'campaign_mode': 'Кампания',
    'single_player': 'Одиночная игра',
    'new_gen_tetris': 'Мастерство карт',
    'daily_challenge': 'Ежедневный вызов',
    'pvp_2_players': 'PvP (2 игрока)',
    'extras': 'Режимы игры',
    'tutorial_mode': 'Обучение',
    'high_scores': 'Лучшие очки',
    ...
    'exit': 'Выход',
    'quit': 'Выйти',
    'button_switch': 'Выбрать',

    # SEKMELER
    'tab_single_player': 'Одиночная игра',
    'tab_pvp_player1': 'PvP — Игрок 1',
    'tab_pvp_player2': 'PvP — Игрок 2',
    'tab_campaign': 'Кампания',
    ...
    'mode_puzzle': 'Головоломка',
    'mode_cascade': 'Каскад',
    'mode_hardcore': 'Хардкор',
    'mode_marathon': 'Марафон',
    'mode_forty_lines': '40 линий',
    'mode_time_attack': 'Атака времени',
    'mode_gravity': 'Гравитация',
    'mode_invisible': 'Невидимый',
    'mode_upside_down': 'Вверх ногами',
    'mode_mirror': 'Зеркало',
    'mode_garbage': 'Мусорные блоки',
    ...
    'mode_narrow': 'Узкий',
    'mode_wide': 'Широкий',
    'mode_card_mastery': 'Мастерство карт',
    'mode_daily': 'Ежедневный',
    'mode_pvp': 'PvP',
    'mode_training': 'Тренировка',
    'mode_practice': 'Практика',
    'mode_custom': 'Свой режим',
    'mode_infinite': 'Бесконечный',
    'mode_timed': 'На время',
    'mode_lines': 'Линии',
    'mode_score': 'Очки',
    'mode_speed': 'Скорость',
    ...
    'campaign_subtitle': '100 уровней приключений',
    'campaign_level': 'Уровень {level}',
    'campaign_world': 'Мир {world}',
    'campaign_select_level': 'Выбор уровня',
    'campaign_locked': '🔒 Заблокировано',
    'campaign_complete': '✅ Завершено',
    'campaign_stars': '⭐ {stars}/3',
    'campaign_score': 'Очки: {score}',
    'campaign_objective': 'Цель',
    'campaign_objectives': 'Цели',
    'campaign_objective_cleared': '✅ Цель выполнена',
    'campaign_failed': 'Провал!',
    'campaign_victory': 'Победа!',
    'campaign_next_level': 'Следующий уровень',
    'campaign_restart': 'Перезапустить',
    'campaign_resume': 'Продолжить',
    'campaign_back': 'Назад',
    'campaign_new_record': 'Новый рекорд!',
    'campaign_world_complete': 'Мир завершён!',
    'campaign_all_complete': 'Все уровни пройдены!',
    'campaign_bonus_stars': 'Бонусные звёзды',
    'campaign_star_earned': '★ Звезда получена!',
    'campaign_no_stars': 'Без звёзд',
    'campaign_one_star': '1 звезда',
    'campaign_two_stars': '2 звезды',
    'campaign_three_stars': '3 звезды',
    'campaign_progress': '{current}/{total} {level_label} | {stars} {stars_label}',
    'campaign_total_stars': 'Всего звёзд: {stars}/{max}',

    # KAMPANYA OBJEKTİFLERİ
    'obj_clear_lines': 'Очистить {count} линий',
    'obj_score': 'Набрать {score} очков',
    'obj_survive': 'Продержаться {seconds} секунд',
    'obj_clear_specials': 'Очистить {count} особых блоков',
    'obj_no_mistakes': 'Без ошибок',
    'obj_tetris': 'Сделать {count} тетрисов',
    'obj_combo': 'Комбо × {count}',
    'obj_time_limit': 'Завершить за {seconds} секунд',
    'obj_lines_in_time': 'Очистить {count} линий за {seconds} секунд',
    'obj_perfect_clear': 'Идеальная очистка × {count}',
    'obj_survive_lines': 'Пережить {count} мусорных линий',

    # KARTLAR
    'card_title': 'Карта',
    'card_draw': 'Взять карту',
    'card_play': 'Разыграть',
    'card_discard': 'Сбросить',
    'card_hand': 'Рука',
    'card_deck': 'Колода',
    'card_empty_hand': 'Рука пуста',
    'card_max_hand': 'Рука полна',
    'card_bonus': 'Бонус карты',
    'card_effect': 'Эффект',
    'card_cooldown': 'Перезарядка',
    'card_ready': 'Готова!',
    'card_activate': 'Активировать',
    'card_passive': 'Пассивная',
    'card_active': 'Активная',
    'card_rare': 'Редкая',
    'card_common': 'Обычная',
    'card_epic': 'Эпическая',
    'card_legendary': 'Легендарная',
    'card_slots': 'Слоты карт: {used}/{max}',
    'card_mastery_title': 'Мастерство карт',
    'card_mastery_desc': 'Используйте карты для победы!',
    ...
    'hud_speed': 'СКОРОСТЬ',
    'hud_pieces': 'ФИГУРЫ',
    'hud_perfect': 'ИДЕАЛЬНО!',
    'hud_back_to_back': 'НАЗАД К НАЗАД!',
    'hud_tspin': 'T-СПИН!',
    'hud_tspin_mini': 'Т-СПИН МИНИ!',
    'hud_tspin_single': 'Т-СПИН ОДИНОЧНЫЙ!',
    'hud_tspin_double': 'Т-СПИН ДВОЙНОЙ!',
    'hud_tspin_triple': 'Т-СПИН ТРОЙНОЙ!',
    'hud_tetris': 'ТЕТРИС!',
    'hud_single': 'ОДИНОЧНЫЙ!',
    'hud_double': 'ДВОЙНОЙ!',
    'hud_triple': 'ТРОЙНОЙ!',
    'hud_quadruple': 'ЧЕТВЕРНОЙ!',
    'hud_all_clear': 'ВСЁ ОЧИЩЕНО!',
    ...
    'pause_back_to_menu': 'В главное меню',

    # GAME OVER
    'game_over_title': 'КОНЕЦ ИГРЫ',
    'game_over_score': 'Ваш счёт: {score}',
    'game_over_best': 'Рекорд: {best}',
    'game_over_new_best': '🎉 Новый рекорд: {score}!',
    'game_over_restart': 'Снова',
    'game_over_menu': 'В меню',
    'game_over_lines': 'Линии: {lines}',
    'game_over_level': 'Уровень: {level}',
    'game_over_time': 'Время: {time}',

    # YENİ REKOR / BAŞARIM
    'new_high_score': '🏆 Новый рекорд!',
    'score_submitted': 'Очки отправлены',
    'rank_up': 'Новый ранг: {rank}',
    ...
    'settings_back': 'Назад',
    'settings_confirm_reset': 'Сбросить все настройки?',
    'settings_restart_required': 'Требуется перезапуск',
    ...
    'settings_fps': 'Кадры в секунду',
    'settings_language_select': 'Выберите язык',
    'settings_das': 'Задержка авто-повтора (DAS)',
    'settings_arr': 'Скорость авто-повтора (ARR)',
    'settings_soft_drop': 'Скорость мягкого падения',
    'settings_ghost': 'Тень фигуры',
    'settings_hold': 'Удержание фигуры',
    'settings_next_count': 'Количество следующих фигур',
    'settings_grid': 'Сетка поля',
    'settings_animations': 'Анимации',
    'settings_particles': 'Частицы',
    'settings_bg_effects': 'Эффекты фона',
    'settings_block_style': 'Стиль блоков',
    'settings_theme': 'Тема',
    'settings_skin': 'Скин',
    'settings_music_playlist': 'Список воспроизведения',
    'settings_shuffle': 'Перемешать',
    'settings_on': 'Вкл',
    'settings_off': 'Выкл',
    'settings_low': 'Низкий',
    ...
    'controls_move_left': 'Влево',
    'controls_move_right': 'Вправо',
    'controls_rotate_cw': 'Поворот по часовой',
    'controls_rotate_ccw': 'Поворот против часовой',
    'controls_rotate_180': 'Поворот на 180°',
    'controls_soft_drop': 'Мягкое падение',
    'controls_hard_drop': 'Жёсткое падение',
    'controls_hold': 'Удержать',
    'controls_pause': 'Пауза',
    'controls_reset': 'Сбросить привязки',
    'controls_press_key': 'Нажмите клавишу…',
    'controls_conflict': 'Конфликт клавиш!',
    'controls_saved': 'Управление сохранено',
    'controls_player1': 'Игрок 1',
    'controls_player2': 'Игрок 2',
    ...
    'user_level': 'Уровень: {level}',
    'user_xp': 'Опыт: {xp}',
    'user_games': 'Игр сыграно: {count}',
    'user_wins': 'Побед: {count}',
    'user_best_score': 'Лучший счёт: {score}',
    'user_total_lines': 'Всего линий: {lines}',
    'user_total_time': 'Общее время: {time}',
    'user_total_pieces': 'Всего фигур: {pieces}',
    'user_favorite': 'Любимый режим',
    'user_edit_profile': 'Изменить профиль',
    'user_change_avatar': 'Сменить аватар',
    'user_confirm_delete': 'Удалить пользователя?',
    ...
    'achievements_progress': 'Прогресс: {current}/{target}',
    'achievements_new': '🏅 Новое достижение!',
    'achievements_all_unlocked': 'Все достижения разблокированы!',
    'achievements_back': 'Назад',
    'achievements_points': 'Очки достижений: {pts}',
    'achievements_count': '{count} из {total} разблокировано',

    # YÜKSEK SKORLAR
    'high_scores_title': 'Таблица рекордов',
    'high_scores_rank': 'Место',
    'high_scores_name': 'Имя',
    'high_scores_score': 'Очки',
    'high_scores_level': 'Ур.',
    'high_scores_lines': 'Линии',
    'high_scores_date': 'Дата',
    'high_scores_mode': 'Режим',
    'high_scores_time': 'Время',
    'high_scores_empty': 'Нет рекордов',
    'high_scores_back': 'Назад',
    'high_scores_clear': 'Очистить',
    'high_scores_confirm_clear': 'Очистить рекорды?',

    # LİDERLİK TABLOSU
    'leaderboard_title': 'Таблица лидеров',
    'leaderboard_global': 'Глобальный',
    'leaderboard_weekly': 'Еженедельный',
    'leaderboard_daily': 'Ежедневный',
    'leaderboard_friends': 'Друзья',
    'leaderboard_loading': 'Загрузка…',
    'leaderboard_error': 'Ошибка загрузки',
    'leaderboard_empty': 'Нет данных',
    'leaderboard_rank': '#{rank}',
    'leaderboard_your_rank': 'Ваше место: #{rank}',
    'leaderboard_back': 'Назад',
    'leaderboard_retry': 'Повторить',
    'leaderboard_refresh': 'Обновить',
    'menu_lb_score': 'Рекорд',
    'menu_lb_title': 'Таблица лидеров',
    'menu_lb_rank': 'Ранг',
    'menu_lb_player': 'Игрок',
    'menu_lb_lines': 'Линии',
    'menu_lb_level': 'Уровень',
    'menu_lb_loading': 'Загрузка…',
    'menu_lb_error': 'Ошибка',
    'menu_lb_empty': 'Нет данных',
    'menu_lb_submit': 'Отправить очки',
    'menu_lb_submitted': 'Очки отправлены!',
    'menu_lb_global': 'Глобальный',
    'menu_lb_weekly': 'Еженедельный',
    'menu_lb_personal_best': 'Личный рекорд',
    'menu_lb_no_score': 'Нет очков',
    ...
    'guide_prev': 'Назад',
    'guide_next': 'Далее',
    'guide_page': 'Страница {page}/{total}',
    'guide_close': 'Закрыть',
    'guide_controls': 'Управление',
    'guide_basics': 'Основы',
    'guide_modes': 'Режимы',
    'guide_tips': 'Советы',
    'guide_scoring': 'Подсчёт очков',
    'guide_specials': 'Особые блоки',
    'guide_cards': 'Карты',
    'guide_campaign': 'Кампания',
    'guide_objectives_desc': 'Выполняйте цели для получения звёзд!',
    'guide_hold_desc': 'Удержание фигуры: используйте клавишу Hold для сохранения фигуры.',
    'guide_ghost_desc': 'Тень: показывает, куда упадёт фигура.',
    'guide_combo_desc': 'Комбо: очищайте линии подряд для умножения очков!',
    'guide_tspin_desc': 'T-Спин: поворачивайте Т-фигуру в щель для бонусных очков.',
    'guide_tetris_desc': 'Тетрис: очистите 4 линии за раз для максимальных очков!',
    'guide_allclear_desc': 'Полная очистка: очистите всё поле для супер-бонуса!',
    'guide_b2b_desc': 'Назад-к-назад: делайте тетрисы или T-спины подряд!',
    'guide_scoring_desc': 'Линии → очки; уровень повышает скорость. Комбо и специальные ходы дают больше!',

    # TUTORIAL
    'tutorial_title': 'Обучение',
    'tutorial_welcome': 'Добро пожаловать в QUADRIX!',
    'tutorial_welcome_title': 'Добро пожаловать!',
    'tutorial_welcome_desc': 'Научитесь играть в QUADRIX шаг за шагом.',
    'tutorial_step': 'Шаг {step}/{total}',
    'tutorial_complete': 'Обучение завершено!',
    'tutorial_skip': 'Пропустить',
    'tutorial_next': 'Далее',
    'tutorial_prev': 'Назад',
    'tutorial_finish': 'Завершить',
    'tutorial_press_key': 'Нажми {key}',
    'tutorial_move_hint': 'Используйте ← → для движения',
    'tutorial_rotate_hint': 'Используйте ↑ для поворота',
    'tutorial_drop_hint': 'Нажмите ↓ для мягкого падения; ПРОБЕЛ для мгновенного',
    'tutorial_hold_hint': 'Нажмите C для удержания фигуры',
    'tutorial_clear_hint': 'Заполните линию, чтобы очистить её',
    'tutorial_goal_1': 'Очистите хотя бы 1 линию!',
    'tutorial_goal_hold': 'Удержите фигуру!',
    'tutorial_goal_drop': 'Бросьте фигуру!',
    'tutorial_well_done': 'Отлично!',
    'tutorial_try_again': 'Попробуйте снова',
    ...
    'pvp_lines': 'Линий',
    'pvp_level': 'Уровень',
    'pvp_pause_hint': 'Нажмите ESC для паузы',
    'pvp_game_over': 'Конец игры!',
    'pvp_wins': 'ПОБЕДЫ!',
    'pvp_round': 'Раунд {round}',
    'pvp_best_of': 'Лучший из {n}',
    'pvp_winner': 'Победитель: {player}!',
    'pvp_draw': 'Ничья!',
    'pvp_rematch': 'Реванш',
    'pvp_menu': 'В меню',
    'pvp_ready': 'Готов?',
    'pvp_go': 'Старт!',
    'pvp_send_garbage': '{player} отправляет мусор!',
    'pvp_lines_diff': 'разница линий',
    'pvp_points_diff': 'очки',
    'pvp_step': 'Ход',
    'pvp_minutes': 'мин',
    'pvp_lines_suffix': 'л.',

    # GÜNLÜK MEYDAN OKUMA
    'daily_challenge_title': 'Ежедневный вызов',
    'daily_challenge_desc': 'Сегодняшний вызов!',
    'daily_challenge_start': 'Начать',
    'daily_challenge_best': 'Лучший результат: {score}',
    'daily_challenge_streak': 'Серия: {days} дней',
    'daily_challenge_complete': 'Вызов выполнен!',
    'daily_challenge_rank': 'Ваш ранг: #{rank}',
    'daily_challenge_locked': 'Уже сыграно сегодня',
    'daily_challenge_tomorrow': 'Новый вызов завтра!',
    'daily_seeds': 'Сид дня',

    # SPRINT MODU
    'sprint_title': 'Спринт',
    'sprint_desc': 'Очистите {lines} линий как можно быстрее!',
    'sprint_lines_left': 'Осталось линий: {lines}',
    'sprint_complete': 'Спринт завершён!',
    'sprint_time': 'Время: {time}',
    'sprint_record': 'Рекорд: {time}',

    # ULTRA MODU
    'ultra_title': 'Ультра',
    'ultra_desc': 'Наберите максимум очков за {seconds} секунд!',
    'ultra_time_left': 'Осталось: {seconds}с',
    'ultra_complete': 'Ультра завершён!',
    'ultra_score': 'Счёт: {score}',

    # ZEN MODU
    'zen_title': 'Дзен',
    'zen_desc': 'Расслабьтесь и играйте без ограничений.',
    'zen_paused': 'Пауза в режиме Дзен',

    # MARATHON
    'marathon_title': 'Марафон',
    'marathon_desc': 'Играйте как можно дольше! Уровень растёт.',
    'marathon_level': 'Уровень {level}/15',
    'marathon_complete': 'Марафон завершён!',

    # SURVIVAL
    'survival_title': 'Выживание',
    'survival_desc': 'Выживайте под атакой мусорных линий!',
    'survival_wave': 'Волна {wave}',
    'survival_lines_incoming': '{lines} линий приближаются!',
    'survival_survived': 'Выжил {minutes} мин!',
    'survival_victory_title': '🏆 ПОБЕДА!',
    'survival_victory_subtitle': 'Вы продержались {minutes} минут!',

    # CASCADE
    'cascade_title': 'Каскад',
    'cascade_desc': 'Создавайте каскадные цепочки!',
    'cascade_x': 'Каскад x{level}!',
    'cascade_mega_bonus': 'МЕГАБОНУС!',

    # HARDCORE
    'hardcore_title': 'Хардкор',
    'hardcore_desc': 'Инвертированное управление, без тени, скрытые следующие фигуры!',
    'hardcore_warning_next': 'Следующий',
    'hardcore_warning_next_value_hidden': 'СКРЫТ',
    'hardcore_warning_hold': 'Удержание',
    'hardcore_warning_hold_value_disabled': 'ОТКЛЮЧЕНО',
    'hardcore_warning_controls': 'Управление',
    'hardcore_warning_controls_value_inverted': 'ИНВЕРТИРОВАНО',

    # COLOR PICKER
    'color_picker_title': 'Выбор цвета',
    'color_picker_cancel': 'Отмена',
    'color_picker_confirm': 'Подтвердить',
    'color_picker_ok': 'ОК',
    'color_picker_hex': 'HEX',
    'color_picker_red': 'Кр',
    'color_picker_green': 'Зел',
    'color_picker_blue': 'Синий',
    'color_picker_alpha': 'Альфа',
    'color_picker_reset': 'Сброс',
    ...
    'label_failed': 'Ошибка!',
    'label_locked': '🔒 Заблокировано',
    'label_unlocked': '🔓 Разблокировано',
    'label_new': 'НОВОЕ!',
    'label_hot': 'ПОПУЛЯРНО',
    'label_beta': 'БЕТА',
    'label_soon': 'СКОРО',
    ...
    # AYAR / SEÇENEK DEĞERLERİ
    'option_true':  'Да',
    'option_false': 'Нет',
    'option_on':    'Вкл',
    'option_off':   'Выкл',
    'option_auto':  'Авто',
    'option_never': 'Никогда',
    'option_always': 'Всегда',
    'option_low':   'Низкий',
    'option_medium': 'Средний',
    'option_high':  'Высокий',
    'option_ultra': 'Ультра',
    'option_none':  'Нет',

    # ÇIKIŞ ONAY
    'exit_confirm_title': 'Выйти?',
    'exit_confirm_msg':   'Вы уверены, что хотите выйти?',
    'exit_confirm_yes':   'Да, выйти',
    'exit_confirm_no':    'Нет, остаться',
    'exit_save_warning':  'Несохранённый прогресс будет потерян!',

    # GRAFİK MENÜSÜ
    'graphics_title': 'Настройки графики',
    'graphics_quality': 'Качество',
    'graphics_effects': 'Эффекты',
    'graphics_particles': 'Частицы',
    'graphics_bg': 'Фон',
    'graphics_apply': 'Применить',
    'graphics_back': 'Назад',

    # AVATARLAR
    'avatar_title': 'Выбор аватара',
    'avatar_select': 'Выбрать',
    'avatar_upload': 'Загрузить фото',
    'avatar_crop': 'Обрезать',
    'avatar_confirm': 'Подтвердить',
    'avatar_cancel': 'Отмена',
    'avatar_preset': 'Готовый',
    'avatar_custom': 'Свой',

    # PIECE WORKSHOP
    'workshop_title': 'Мастерская фигур',
    'workshop_save': 'Сохранить',
    'workshop_load': 'Загрузить',
    'workshop_clear': 'Очистить',
    'workshop_rotate': 'Повернуть',
    'workshop_flip': 'Отразить',
    'workshop_delete': 'Удалить',
    'workshop_name': 'Имя фигуры',
    'workshop_saved': 'Фигура сохранена!',
    'workshop_confirm_delete': 'Удалить фигуру?',

    # BLOCK STYLES
    'block_style_classic': 'Классика',
    'block_style_modern': 'Современный',
    'block_style_neon': 'Неон',
    'block_style_pixel': 'Пиксель',
    'block_style_glass': 'Стекло',
    'block_style_jelly': 'Желе',
    'block_style_minimal': 'Минимализм',
    'block_style_retro': 'Ретро',
    'block_style_round': 'Круглый',
    'block_style_flat': 'Плоский',
    'block_style_metallic': 'Металлический',
    'block_style_pastel': 'Пастель',
    'block_style_dark': 'Тёмный',
    'block_style_default': 'По умолчанию',

    # ÖZEL BLOKLAR
    'special_block_bomb': 'Бомба',
    'special_block_steel': 'Стальной блок',
    'special_block_lock': 'Заблокированный',
    'special_block_glass': 'Стеклянный',
    'special_block_paint': 'Краска',
    'special_block_ghost': 'Призрак',
    'special_block_wildcard': 'Джокер',
    'special_block_rainbow': 'Радуга',
    'special_block_virus': 'Вирус',
    'special_block_freeze': 'Заморозить',
    'special_block_clear': 'Очиститель',
    'special_block_multiplier': 'Умножитель',

    # POWER-UPS (GÜÇLENDİRMELER)
    'powerup_title': 'Бонусы',
    'powerup_clear_line': 'Очистить линию',
    'powerup_slow_time': 'Замедление',
    'powerup_add_time': '+{seconds}с',
    'powerup_double_score': 'Двойные очки',
    'powerup_shield': 'Щит',
    'powerup_bomb': 'Бомба',
    'powerup_freeze': 'Заморозка',
    'powerup_remove_garbage': 'Убрать мусор',
    'powerup_next_reveal': 'Показать следующую',
    'powerup_activated': '{name} активирован!',
    'powerup_ready': '{name} готов!',

    # KREDİ / AVTOR
    'credits_title': 'Авторы',
    'credits_dev': 'Разработка',
    'credits_design': 'Дизайн',
    'credits_music': 'Музыка',
    'credits_sfx': 'Звуки',
    'credits_thanks': 'Благодарности',
    'credits_close': 'Закрыть',
    'credits_version': 'Версия {version}',

    # STEAM
    'steam_title': 'Steam',
    'steam_leaderboard': 'Таблица лидеров Steam',
    'steam_achievements': 'Достижения Steam',
    'steam_connecting': 'Подключение к Steam…',
    'steam_connected': 'Steam подключён',
    'steam_disconnected': 'Steam отключён',
    'steam_error': 'Ошибка Steam',
    'steam_submit_score': 'Отправить очки',
    'steam_score_submitted': 'Очки отправлены!',
    'steam_rank': 'Ранг Steam',
    ...
    'timer_running': 'Идёт…',
    'timer_paused': 'Пауза',
    'timer_stopped': 'Остановлено',
    'timer_start': 'Старт',
    'timer_pause': 'Пауза',
    'timer_stop': 'Стоп',
    'timer_reset': 'Сбросить',
    'timer_lap': 'Круг',

    # OYUN MODU AÇIKLAMALARI (Extras / Mode Cards)
    'mode_desc_classic':    'Классический тетрис. Очищайте линии и набирайте очки.',
    'mode_desc_sprint':     'Очистите {lines} линий за минимальное время!',
    'mode_desc_ultra':      'Максимум очков за {seconds} секунд!',
    'mode_desc_zen':        'Расслабляющая игра без game-over.',
    'mode_desc_blitz':      'Набирайте очки так быстро, как можете! ({seconds}с)',
    'mode_desc_survival':   'Выживайте под атаками мусора.',
    'mode_desc_cascade':    'Стройте каскадные комбо!',
    'mode_desc_hardcore':   'Инвертированное управление, нет тени, нет следующей фигуры.',
    'mode_desc_marathon':   'Классика с нарастающей сложностью до уровня 15.',
    'mode_desc_puzzle':     'Решайте головоломки с фигурами!',
    'mode_desc_combo':      'Держите комбо на максимуме!',
    'mode_desc_cheese':     'Разберитесь с мусорными линиями снизу.',
    'mode_desc_dig':        'Копайтесь сквозь мусорные линии!',
    'mode_desc_pvp':        'Играйте против другого игрока на одном экране.',
    'mode_desc_card_mastery': 'Используйте карты для победы!',
    'mode_desc_daily':      'Ежедневный вызов. Один шанс в день!',
    'mode_desc_training':   'Тренируйтесь в любом режиме.',
    'mode_desc_sandbox':    'Полная свобода. Делайте что угодно!',

    # ACTIVE TILE LABELS (Ana menü kartları)
    'tile_label_start': 'Старт',
    'tile_label_campaign': 'Кампания',
    'tile_label_pvp': 'PvP',
    'tile_label_daily': 'Ежедневный',
    'tile_label_high_scores': 'Рекорды',
    'tile_label_settings': 'Настройки',
    'tile_label_achievements': 'Достижения',
    'tile_label_guide': 'Руководство',
    'tile_label_credits': 'Авторы',
    'tile_label_quit': 'Выйти',
    'tile_label_leaderboard': 'Лидеры',
    'tile_label_modes': 'Режимы',
    'tile_label_profile': 'Профиль',
    'tile_label_tutorial': 'Обучение',
    'tile_label_extras': 'Ещё',
    'tile_label_workshop': 'Мастерская',

    # PLATFORM / HATA
    'error_title': 'Ошибка',
    'error_unknown': 'Произошла ошибка',
    'error_load_failed': 'Загрузка не удалась',
    'error_save_failed': 'Сохранение не удалось',
    'error_network': 'Ошибка сети',
    'error_steam': 'Ошибка Steam',
    ...
    'music_next': 'Следующий',
    'music_prev': 'Предыдущий',
    'music_shuffle': 'Перемешать',
    'music_repeat': 'Повтор',
    'music_mute': 'Выключить звук',
    'music_unmute': 'Включить звук',
    'music_volume': 'Громкость',
    'music_playlist': 'Плейлист',
    'music_add': 'Добавить',
    'music_remove': 'Удалить',
    'music_edit': 'Изменить',
    'music_save': 'Сохранить',
    'music_none': 'Нет музыки',
    'music_default': 'Стандартная',

    # PLAYLIST EDITOR
    'playlist_editor_title': 'Редактор плейлиста',
    'playlist_editor_add': 'Добавить трек',
    'playlist_editor_remove': 'Удалить',
    'playlist_editor_move_up': 'Вверх',
    'playlist_editor_move_down': 'Вниз',
    'playlist_editor_save': 'Сохранить',
    'playlist_editor_cancel': 'Отмена',
    'playlist_editor_empty': 'Плейлист пуст',
    'playlist_add': '+ Добавить',
    ...
    'stats_best_score': 'Лучший счёт',
    'stats_best_streak': 'Лучшая серия',
    'stats_avg_score': 'Средний счёт',
    'stats_tetrises': 'Тетрисов',
    'stats_tspins': 'T-Спинов',
    'stats_all_clears': 'Полных очисток',
    'stats_highest_combo': 'Макс. комбо',
    'stats_per_mode': 'По режимам',
    'stats_reset': 'Сбросить статистику',

    # NOTIFICATIONS
    'notif_level_up': 'Уровень {level}!',
    'notif_achievement': '🏅 {name}',
    'notif_star_earned': '⭐ Звезда получена!',
    'notif_high_score': '🏆 Новый рекорд!',
    'notif_daily_done': '✅ Вызов выполнен!',

    # SÜRÜM BİLGİSİ
    'version_label': 'v{version}',
    'build_label': 'Сборка {build}',
    ...
    # GAME MODE CARD TITLE EXTRAS
    'mode_card_classic_title':  'Классика',
    'mode_card_sprint_title':   'Спринт',
    'mode_card_ultra_title':    'Ультра',
    'mode_card_zen_title':      'Дзен',
    'mode_card_blitz_title':    'Блиц',
    'mode_card_survival_title': 'Выживание',
    'mode_card_cascade_title':  'Каскад',
    'mode_card_hardcore_title': 'Хардкор',
    'mode_card_marathon_title': 'Марафон',
    'mode_card_combo_title':    'Комбо',
    'mode_card_pvp_title':      'PvP',
    'mode_card_daily_title':    'Ежедневный',
    'mode_card_card_mastery_title': 'Мастерство карт',

    # SES AYARLARI
    'track_count_unit': 'треков',
    'mode_music_playlist_editor': 'Редактор музыки режимов',

    # =====================================================================
    # НИЖЕ: Автоматически добавленные переводы для ~730 отсутствующих ключей
    # =====================================================================

    # --- ДОСТИЖЕНИЯ ---
    'ach_progress_format': 'Прогресс: {current}/{target} ({percent}%)',
    'ach_progress_unknown': 'Прогресс: -',
    'achievement_unlocked': 'Достижение разблокировано!',

    # --- ОБЩИЕ ЭЛЕМЕНТЫ ИНТЕРФЕЙСА ---
    'active_label': 'Активно: {current}',
    'arrows': 'Стрелки',
    ...
    'combo': 'Комбо',
    'controls': 'Управление',
    'custom_count': '{count} пользовательских',
    'date': 'Дата',
    ...
    'level': 'Уровень',
    'lines': 'Линии',
    'lines_cleared': 'Очищено линий',
    'loading': 'Загрузка',
    'main_menu': 'Главное меню',
    'moves': 'Ходы',
    'music': 'Музыка',
    'next': 'Следующий:',
    'no_scores': 'Результатов пока нет',
    'none': 'Нет',
    ...
    # --- АВАТАР ---
    'avatar_all_files': 'Все файлы',
    'avatar_edit_title': 'Редактирование аватара',
    'avatar_image_files': 'Файлы изображений',
    'avatar_key_cancel': 'Отмена',
    'avatar_key_drag': 'Перемещение/Масштаб',
    'avatar_key_move': 'Передвинуть рамку',
    'avatar_key_save': 'Сохранить',
    'avatar_key_select': 'Выбрать',
    'avatar_key_size': 'Размер',
    'avatar_no_image_selected': 'Изображение не выбрано',
    'avatar_press_s': 'Нажмите S или',
    'avatar_preview': 'Предпросмотр',
    'avatar_select_file': 'выберите файл изображения',
    'avatar_select_image': 'Выбрать изображение аватара',

    # --- ФОН ---
    'bg_default': 'По умолчанию',
    'bg_main': 'Основной фон',
    'bg_outer': 'Фон внешней области',
    'bg_pvp_board': 'Поля PvP',
    'bg_pvp_main': 'Основной фон PvP',
    'bg_single': 'Поле одиночной игры',
    'bg_title': 'ВЫБОР ФОНА',
    'bg_transparency': 'Прозрачность',
    'bg_wide': 'Фон широкого режима',

    # --- СТИЛИ БЛОКОВ ---
    'block_style_btn_custom': 'Свой',
    'block_style_btn_default': 'По умолчанию',
    'block_style_copy_log': '\u00ad\u015f\u0104\u00bf Тема {source} скопирована в {target}',
    'block_style_footer_line1_block': 'Двойной клик: Выбрать цвет | R: Сбросить цвет',
    'block_style_footer_line1_custom': 'Двойной клик: Выбрать цвет | R: По умолчанию | C: Копировать из темы ({theme})',
    'block_style_footer_line2_block': 'TAB: Переключить режим | Мышь: Прокрутка | ESC: Назад | F12: Полный экран',
    'block_style_footer_line2_custom': 'TAB: Переключить режим ({theme}) | Мышь: Прокрутка | ESC: Назад | F12: Полный экран',
    'block_style_mode_changed_log': '🔁 Режим изменён: {mode}',
    'block_style_reset_all_log': '♻️ Все стили блоков сброшены к теме по умолчанию',
    'block_styles': 'Стили блоков',
    'block_styles_showcase_desc': 'Настройте цвета блоков!',

    # --- МАСТЕРСКАЯ БЛОКОВ ---
    'block_workshop_action_delete': 'Удалить',
    'block_workshop_action_duplicate': 'Дублировать',
    'block_workshop_action_modes': 'Режимы',
    'block_workshop_action_new': 'Создать',
    'block_workshop_action_rename': 'Переименовать',
    'block_workshop_block_color_updated': 'Цвет блока обновлён',
    'block_workshop_block_colors_reset': 'Цвета блоков сброшены',
    'block_workshop_block_empty': 'Этот блок пуст',
    'block_workshop_block_name': '{label} №{index}',
    'block_workshop_cell_color_reset': 'Цвет ячейки сброшен',
    'block_workshop_cell_color_updated': 'Цвет ячейки обновлён',
    'block_workshop_cell_empty': 'Эта ячейка пуста',
    'block_workshop_clear_board': 'Поле очищено',
    'block_workshop_default_set': 'Набор по умолчанию',
    'block_workshop_instructions_line1': '🖱️ ЛКМ: Рисовать  |  ПКМ: Стирать  |  K: Сменить цвет',
    'block_workshop_instructions_line2': '🎯 DEL: Очистить  |  {modifier}+S: Сохранить  |  [ ]: Переключить набор',
    'block_workshop_manager_empty': 'Сохранённых блоков пока нет.',
    'block_workshop_manager_instructions_line1': '↑/↓: Выбрать блок | ←/→: Фокус режима | ПРОБЕЛ или 1-0: Переключить режим',
    'block_workshop_manager_instructions_line2': 'DEL: Удалить блок | K: Цвет блока | SHIFT+K: Сбросить цвет | ENTER: К полю | M/Esc: Закрыть',
    'block_workshop_manager_instructions_line3': '{modifier}+N: Новый набор | {modifier}+D: Дублировать | {modifier}+Del: Удалить | F2: Переименовать | {modifier}+M: Режимы',
    'block_workshop_manager_row_label': '{index}. {cells} яч.  область: {width}x{height}',
    'block_workshop_manager_selected_info': 'Выбранный блок: {cells} яч. · Область: {width}x{height}',
    'block_workshop_manager_title': 'Менеджер блоков',
    'block_workshop_message_loaded': 'Последнее сохранение загружено',
    'block_workshop_min_one_set': 'Должен остаться хотя бы один набор',
    'block_workshop_new_set_created': 'Новый набор создан',
    'block_workshop_no_packages': 'Наборов пока нет (создайте с помощью {modifier}+N).',
    'block_workshop_no_saved_blocks': 'Сохранённых блоков пока нет',
    'block_workshop_out_of_bounds': 'Нельзя размещать за пределами поля',
    'block_workshop_packages_title': 'Наборы',
    'block_workshop_saved': 'Мастерская сохранена',
    'block_workshop_saved_block_label': '{index}. {cells} яч.  {width}x{height}',
    'block_workshop_saved_blocks_count': '{count} блоков',
    'block_workshop_saved_blocks_title': '📦 Сохранённые блоки',
    'block_workshop_set_base': 'Набор',
    'block_workshop_set_copy_suffix': 'Копия',
    'block_workshop_set_deleted': '«{name}» удалён',
    'block_workshop_set_loaded': '«{name}» загружен',
    'block_workshop_set_mode_hint_line1': '←/→ или 1-0: Выбрать режим',
    'block_workshop_set_mode_hint_line2': 'Пробел/Enter: Переключить  ·  Esc: Закрыть',
    'block_workshop_set_mode_title': 'Видимость набора в режимах',
    'block_workshop_set_modes_updated': 'Режимы набора обновлены',
    'block_workshop_set_name_prompt': 'Введите новое название набора:',
    'block_workshop_set_name_title': 'Название набора',
    'block_workshop_set_name_updated': 'Название набора обновлено',
    'block_workshop_set_number': 'Набор {index}',
    'block_workshop_side_info_angle': '🔄 Угол: {angle}°',
    'block_workshop_side_info_cells': '🔳 Ячейки: {count}',
    'block_workshop_tip': 'TAB: Выбрать фигуру  |  Q/E: Повернуть  |  ENTER: Поставить  |  M: Менеджер блоков',
    'block_workshop_title': 'МАСТЕРСКАЯ БЛОКОВ',

    # --- БРАУЗЕР ---
    'browser_open_failed': 'Не удалось открыть браузер.',

    # --- КАМПАНИЯ ---
    'campaign_block_limit_title': 'Осталось блоков',
    'campaign_boss': 'БОСС',
    'campaign_cond_combo': 'Соберите цепочку из {value} (подряд очищайте линии)',
    'campaign_cond_combo_chain': '{value} комбо подряд',
    'campaign_cond_complete': 'Пройдите уровень',
    'campaign_cond_efficiency': '+{value} доп. прогресс',
    'campaign_cond_extra_lines': '+{value} доп. линий',
    'campaign_cond_multi_clear_2': 'Выполните Double (2 линии)',
    'campaign_cond_multi_clear_3': 'Выполните Triple (3 линии)',
    'campaign_cond_multi_clear_n': 'Очистите {value} линий за раз',
    'campaign_cond_score': '{value} очков',
    'campaign_cond_tetris': 'Выполните {value} Quadrix',
    'campaign_cond_time': 'за {value} сек.',
    'campaign_cond_time_limit': 'Завершите за {value} сек.',
    'campaign_congrats_title': 'ПОЗДРАВЛЯЕМ!',
    'campaign_difficulty': 'Сложность',
    'campaign_fail_blocks': 'Блоки закончились!',
    'campaign_fail_time': 'Время вышло!',
    'campaign_failed_hint': '[R] Повтор | [ESC] Меню',
    'campaign_retry': 'Попробовать снова',
    'campaign_failed_title': 'ПРОВАЛ!',
    'campaign_footer_controls': 'ENTER: Продолжить   ESC: Меню',
    'campaign_max_combo': 'Макс. комбо',
    'campaign_mini_boss': 'Мини-босс',
    'campaign_new_world': 'Новый мир',
    'campaign_next_level_title': 'СЛЕДУЮЩИЙ УРОВЕНЬ',
    'campaign_obj_clear_garbage': 'Очистите все мусорные блоки',
    'campaign_obj_clear_lines': 'Очистите {target} линий',
    'campaign_obj_combo': 'Соберите цепочку из {target} (подряд очищайте линии)',
    'campaign_obj_move_efficiency': 'Завершите за {target} ходов',
    'campaign_obj_perfect_clear': '{target} идеальных очищений',
    'campaign_obj_score': '{target} очков',
    'campaign_obj_special_block': 'Очистите {target} спецблоков',
    'campaign_obj_survival': 'Продержитесь {target} секунд',
    'campaign_obj_tetris': 'Выполните {target} Quadrix',
    'campaign_obj_time': 'Завершите за {target} секунд',
    'campaign_objectives_title': 'ЦЕЛИ',
    'campaign_play': 'ИГРАТЬ',
    'campaign_progress': '{current}/{total} {level_label} | {stars} {stars_label}',
    'campaign_remaining_time': 'Осталось: {seconds} сек.',
    'campaign_reward_card_cosmetic': 'Карта/Косметика',
    'campaign_rewards_title': 'НАГРАДЫ',
    'campaign_rule_block_limit': 'Лимит блоков: {value}',
    'campaign_rule_cascade': 'Каскад',
    'campaign_rule_no_hold': 'Без удержания',
    'campaign_rule_no_preview': 'Без предпросмотра',
    'campaign_rule_special_blocks': 'Спецблоки: {value}',
    'campaign_rule_time_limit': 'Лимит времени: {value} сек.',
    'campaign_rules': 'Правила',
    'campaign_rules_standard': 'Стандартные',
    'campaign_star_conditions_title': 'УСЛОВИЯ ЗВЁЗД',
    'campaign_stats_title': 'СТАТИСТИКА',
    'campaign_status_locked': 'ЗАБЛОКИРОВАНО',
    'campaign_status_perfect': 'ИДЕАЛЬНО!',
    'campaign_status_ready': 'ГОТОВО',
    'campaign_status_stars': '{stars} ЗВЁЗД',
    'campaign_world_progress': 'Прогресс мира',
    'campaign_world_tab_format': 'М{index} {name}',

    # --- КАРТЫ ---
    'card_debug': 'Отладка карт',
    'card_hint_equal': 'Равный шанс для всех карт',
    'card_hint_random': 'Полностью случайно',
    'card_level_progress': 'Прогресс уровня: {current}/{needed}',
    'card_placeholder_empty': 'Карт пока нет',
    'card_placeholder_no_limited': 'Нет ограниченных карт',
    'card_pool_label': 'Пул карт: {hint}',
    'card_selected': '{title} выбрана!',
    'card_skip_selection': 'Продолжить без карты',
    'card_reroll_selection': 'Перетасовать',
    'card_type_limited': 'Ограниченные',

    # --- КАСКАД ---
    'cascade_level_message': 'КАСКАД x{level}!',
    'cascade_tip_line1': 'Линии падают —',
    'cascade_tip_line2': 'Цепной бонус!',
    ...
    # --- УПРАВЛЕНИЕ ---
    'control_status_hint': 'ENTER: Назначить клавишу  |  R: Сбросить вкладку  |  TAB: Сменить вкладку  |  ВЛЕВО/ВПРАВО: Основная/Доп.',
    'control_tab_reset': 'Вкладка сброшена к настройкам по умолчанию',

    # --- АВТОРЫ ---
    'credits_copyright': '© 2025 — Все права защищены',
    'credits_esc_hint': 'ESC — Главное меню',
    'credits_screen_subtitle': 'Команда и сообщество, которые сделали это возможным',
    'credits_screen_title': 'АВТОРЫ',
    'credits_social_info': 'Instagram: @vibecode.production  |  Github: github.com/ardadmrknn  |  Email: {email}',
    'credits_special_thanks_title': 'Особая благодарность',
    'credits_testers_close_hint': 'ESC или клик вне окна: Закрыть',
    'credits_testers_title': 'Тестировщики',

    # --- ДЕЙСТВИЯ УПРАВЛЕНИЯ ---
    'ctrl_fullscreen_toggle': 'Полный экран',
    'ctrl_hard_drop': 'Быстрый сброс',
    'ctrl_hold': 'Удержание / Обмен',
    'ctrl_move_left': 'Движение влево',
    'ctrl_move_right': 'Движение вправо',
    'ctrl_pause': 'Пауза',
    'ctrl_rotate': 'Поворот',
    'ctrl_soft_drop': 'Мягкий сброс',
    'ctrl_toggle_fps': 'Переключить FPS',

    # --- ЕЖЕДНЕВНЫЕ ИСПЫТАНИЯ ---
    'daily_completed': 'Сегодняшнее испытание пройдено',
    'daily_completed_hint': 'Выполнено ✔',
    'daily_lives_remaining_hint': 'Осталось жизней: {remaining}/{max}',
    'daily_no_attempts': 'Все попытки использованы. Попробуйте завтра!',
    'daily_no_user': 'Сначала выберите пользователя!',
    'daily_prompt_missing': 'Не удалось загрузить данные испытания.',
    'daily_prompt_title': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ',

    # --- DAS / СКОРОСТЬ ---
    'das_delay': 'Задержка автосдвига (DAS)',
    'das_repeat': 'Скорость автоповтора (ARR)',
    ...
    # --- РЕЖИМ ОТОБРАЖЕНИЯ / ПЕРЕЗАПУСК ---
    'display_mode_restart_message': 'Для применения изменений необходимо перезапустить игру.',
    'display_mode_restart_no': 'Нет, отмена',
    'display_mode_restart_title': 'ТРЕБУЕТСЯ ПЕРЕЗАПУСК',
    'display_mode_restart_yes': 'Да, закрыть',

    # --- ВЫХОД ---
    'exit_confirm_message': 'Игра будет закрыта. Несохранённый прогресс может быть потерян.',

    # --- ИГРОВЫЕ РЕЖИМЫ ---
    'extras_subtitle': 'Разные правила, разные эмоции!',
    'extras_title': 'ИГРОВЫЕ РЕЖИМЫ',

    # --- НАСТРОЙКИ ЭКРАНА ---
    'fps_limit': 'Лимит FPS',
    'fullscreen': 'Полный экран',
    'resolution': 'Размер окна',
    'show_background': 'Показать фон',
    'show_fps': 'Показать FPS',
    'show_ghost': 'Показать тень',
    'vsync': 'VSync',
    'vsync_changed': 'VSync изменён',
    'vsync_restart_msg1': 'Для применения VSync',
    'vsync_restart_msg2': 'необходимо перезапустить игру.',
    'vsync_restart_msg3': 'Перезапустить сейчас?',
    'window_mode': 'Режим окна',
    'windowed': 'Оконный',

    # --- ЗВУК ---
    'game_music': 'Игровая музыка',
    'menu_music': 'Музыка меню',
    'menu_music_volume': 'Громкость музыки меню',
    'sfx_volume': 'Громкость эффектов',
    'sound_effects': 'Звуковые эффекты',

    # --- ИГРА ---
    'game_over': 'ИГРА ОКОНЧЕНА',
    'game_over_hint': 'Нажмите R для перезапуска, ESC для меню.',
    'game_over_subtitle': 'Результаты сохранены, попробуйте снова!',
    'gameplay_settings': 'НАСТРОЙКИ ГЕЙМПЛЕЯ',

    # --- ГЕЙМПАД: КАРТЫ ---
    'gp_card_bomb': 'Bomb Master',
    'gp_card_ghost': 'Ghost Piece',
    'gp_card_hammer': 'Hammer',
    'gp_card_phase_shift': 'Phase Shift',
    'gp_card_rewind': 'Rewind',
    'gp_card_sniper': 'Sniper Shot',
    'gp_card_time_capsule_restore': 'Восстановить Time Capsule',
    'gp_card_time_capsule_save': 'Сохранить Time Capsule',

    # --- ГЕЙМПАД: НАСТРОЙКИ ---
    'gp_deadzone': 'Мёртвая зона',
    'gp_discard_held': 'Сбросить удержанное',
    'gp_enabled': 'Геймпад включён',
    'gp_hard_drop': 'Быстрый сброс',
    'gp_hold': 'Удержание / Обмен',
    'gp_hold2': '2-й карман',
    'gp_lt': 'LT (Левый триггер)',
    'gp_main_menu_prompt': 'Запрос главного меню',
    'gp_menu_back': 'Назад',
    'gp_menu_confirm': 'Подтвердить / Выбрать',
    'gp_menu_navigate': 'Навигация: D-Pad / Левый стик',
    'gp_menu_tab_next': 'Следующая вкладка',
    'gp_menu_tab_prev': 'Предыдущая вкладка',
    'gp_mouse_sensitivity': 'Чувствительность мыши',
    'gp_move_direction': 'Движение: D-Pad / Левый стик',
    'gp_off': 'Выкл',
    'gp_on': 'Вкл',
    'gp_pause': 'Пауза',
    'gp_press_button': 'Нажмите кнопку геймпада...',
    'gp_rt': 'RT (Правый триггер)',
    'gp_rumble': 'Вибрация',
    'gp_section_card': 'Режим карт',
    'gp_section_general': 'Общее',
    'gp_section_ingame': 'В игре',
    'gp_section_menu': 'Главное меню',
    'gp_status_connected': '✅ Подключён',
    'gp_status_disconnected': '❌ Не подключён',
    'gp_unbound': 'Не назначено',

    # --- НАСТРОЙКИ ГРАФИКИ ---
    'graphics_settings': 'НАСТРОЙКИ ГРАФИКИ',
    'particle_effects': 'Эффекты частиц',

    # --- РУКОВОДСТВО ---
    'guide_action_hard_drop': 'Быстрый сброс',
    'guide_action_hold': 'Удержать фигуру',
    'guide_action_move': 'Движение',
    'guide_action_pause': 'Пауза',
    'guide_action_restart': 'Перезапуск',
    'guide_action_rotate': 'Поворот',
    'guide_action_soft_drop': 'Мягкий сброс',
    'guide_controls_header': '⌨⌨⌨ УПРАВЛЕНИЕ ⌨⌨⌨',
    'guide_controls_left_right_arrows': 'Стрелки влево/вправо',
    'guide_controls_line': '• {keys}: {action}',

    # --- ТАБЛИЦЫ РЕКОРДОВ ---
    'high_scores_hint': '↑ ↓ : Прокрутка  |  ESC : Назад',
    'highest_combo': 'Макс. комбо',
    'highest_level': 'Макс. уровень',

    # --- ПОДСКАЗКИ ---
    'hint_select_apply_close': '↑ ↓: Выбор  |  ENTER: Применить  |  ESC / Клик вне окна: Закрыть',
    'hint_select_open_close': '↑ ↓: Выбор  |  ENTER: Открыть  |  ESC / Клик вне окна: Закрыть',
    'hud_key_uses': '{label}: {count}',

    # --- КЛАВИШИ ---
    'key_caps_lock': 'Caps Lock',
    'key_down_arrow': 'Стрелка вниз',
    'key_escape': 'ESC',
    'key_left_alt': 'Левый Alt',
    'key_left_arrow': 'Стрелка влево',
    'key_left_ctrl': 'Левый Ctrl',
    'key_left_shift': 'Левый Shift',
    'key_right_alt': 'Правый Alt',
    'key_right_arrow': 'Стрелка вправо',
    'key_right_ctrl': 'Правый Ctrl',
    'key_right_shift': 'Правый Shift',
    'key_up_arrow': 'Стрелка вверх',
    'keys_left_right': 'Влево/Вправо',
    'keys_tab_up_down': 'Tab/Вверх/Вниз',

    # --- МЕНЮ: ПАНЕЛЬ УПРАВЛЕНИЯ ---
    'menu_achievements_progress': '{count}/{total} достижений разблокировано — {percent}%',
    'menu_back': 'Назад',
    'menu_dashboard_campaign_level_single': 'Ур. {level}',
    'menu_dashboard_campaign_levels': 'Последний: Ур. {last}  ·  Следующий: Ур. {next}',
    'menu_dashboard_campaign_title': 'Режим кампании',
    'menu_dashboard_completion_percent': 'Завершено {percent}%',
    'menu_dashboard_daily_fallback': 'Пройдите сегодняшнее испытание',
    'menu_dashboard_no_achievements': 'Достижений пока нет',
    'menu_dashboard_pvp_title': 'Онлайн PvP / Кооператив',
    'menu_dashboard_quick_continue': 'Быстрое продолжение',
    'menu_dashboard_sub_block_styles': 'Настройте тему и стиль блоков',
    'menu_dashboard_sub_piece_workshop': 'Создавайте и сохраняйте фигуры',
    'menu_dashboard_sub_pvp': 'Онлайн и кооператив скоро',
    'menu_dashboard_sub_tutorial': 'Прыгайте и учитесь!',
    'menu_gamepad_label': 'Геймпад',
    'menu_header_subtitle': 'Расслабьтесь и сообщайте о проблемах через верхний правый угол.',
    'menu_hint_enter_y': 'ENTER / Y',
    'menu_hint_esc_n': 'ESC / N',
    'menu_hint_select': 'Выбор: Мышью или клавиатурой',
    'menu_key_reset': 'Выбранная клавиша сброшена',

    # --- МЕНЮ: ТАБЛИЦА ЛИДЕРОВ ---
    'menu_lb_error_config_missing': 'LEADERBOARD_BACKEND_URL или STEAM_APP_ID/STEAM_WEB_API_KEY не настроены.',
    'menu_lb_error_fetch_failed': 'Не удалось получить данные Steam: {error}',
    'menu_lb_error_friends_auth': 'Для списка друзей требуется авторизация.',
    'menu_lb_error_global_missing': 'Глобальные результаты не найдены.',
    'menu_lb_no_scores': 'Результатов не найдено.',
    'menu_lb_subtitle': 'Мастерство карт (Steam)',
    'menu_lb_tab_friends': 'Друзья',
    'menu_lb_tab_global': 'Глобальный',
    'menu_lb_unknown_user': 'неизвестно',

    # --- МЕНЮ: МУЗЫКА ---
    'menu_music_hint': '↑ ↓: Выбор  |  ENTER: Применить  |  ESC / Клик вне окна: Закрыть  |  R: Обновить',
    'menu_music_select': 'ВЫБОР МУЗЫКИ',
    'menu_theme_hint': '↑ ↓: Выбор  |  ENTER: По умолч.  |  ← → / Клик: Список  |  ESC: Назад',
    'menu_transparency': 'Прозрачность меню',
    'menu_yes_exit': 'Да, выйти',

    # --- МЕТКИ РЕЖИМОВ ---
    'mode_label_card_mastery': 'Мастерство карт',
    'mode_label_cascade': 'Каскад',
    'mode_label_classic': 'Классика',
    'mode_label_hardcore': 'Хардкор',
    'mode_label_sprint': 'Спринт',
    'mode_label_ultra': 'Ультра',
    'mode_label_wide': 'Широкий',
    'mode_label_zen': 'Дзен',

    # --- МУЗЫКА РЕЖИМОВ ---
    'mode_music': 'МУЗЫКА РЕЖИМА',
    'mode_music_label': 'Музыка режима',
    'mode_tetris_extra': 'QUADRIX EXTRA',
    'music_campaign': 'Режим кампании',
    'music_cascade': 'Режим каскада',
    'music_classic': 'Классика (Одиночная игра)',
    'music_daily': 'Ежедневное испытание',
    'music_hardcore': 'Режим хардкора',
    'music_mystery': 'Мастерство карт',
    'music_pvp': 'Локальный PvP (2 игрока)',
    'music_sprint': 'Режим спринта',
    'music_survival': 'Режим выживания',
    'music_tetris2': 'Quadrix Extra',
    'music_ultra': 'Режим ультра',
    'music_wide': 'Широкий режим',
    'music_zen': 'Режим дзен',

    # --- ПАНЕЛИ ---
    'panel_best_scores': 'ЛУЧШИЕ РЕЗУЛЬТАТЫ',
    'panel_best_times': 'ЛУЧШЕЕ ВРЕМЯ',
    'panel_block_styles': 'СТИЛИ БЛОКОВ',
    'panel_controls': 'УПРАВЛЕНИЕ',
    'panel_no_records': 'Нет записей',
    'panel_settings': 'НАСТРОЙКИ',
    'panel_theme': 'ВЫБОР ТЕМЫ',

    # --- ПАУЗА ---
    'pause_hint': 'Вверх/Вниз — выбор   Влево/Вправо — изменить   Enter — подтвердить   P — продолжить   Мышь: Клик/Колёсико',

    # --- МАСТЕРСКАЯ ФИГУР ---
    'piece_workshop': 'Мастерская фигур',
    'piece_workshop_all_modes': 'Все режимы',
    'piece_workshop_block_added': 'Блок добавлен (осталось {remaining})',
    'piece_workshop_block_count': '{count} блоков',
    'piece_workshop_block_deleted': 'Блок удалён',
    'piece_workshop_blocks_connected_required': 'Блоки должны быть соединены!',
    'piece_workshop_blocks_not_connected': 'Блоки не соединены!',
    'piece_workshop_cannot_delete_breaks': 'Нельзя удалить этот блок (нарушится связь)!',
    'piece_workshop_color_changed': 'Цвет изменён',
    'piece_workshop_color_selected': 'Цвет выбран',
    'piece_workshop_counter': '{count}/{max_blocks} блоков',
    'piece_workshop_custom_color': 'ПОЛЬЗОВАТЕЛЬСКИЙ ЦВЕТ',
    'piece_workshop_custom_color_active': 'Пользовательский цвет активен',
    'piece_workshop_custom_color_cancelled': 'Выбор цвета отменён',
    'piece_workshop_custom_color_changed': 'Пользовательский цвет изменён',
    'piece_workshop_custom_name': 'Свой №{index}',
    'piece_workshop_delete_button': '{modifier}+D : Удалить',
    'piece_workshop_edit_closed': 'Редактирование закрыто',
    'piece_workshop_editing': 'Редактирование «{name}»',
    'piece_workshop_grid_cleared': 'Сетка очищена',
    'piece_workshop_load_failed': '⚠️ Не удалось загрузить мастерскую: {error}',
    'piece_workshop_max_blocks': 'Максимум {max_blocks} блоков!',
    'piece_workshop_min_blocks': 'Нужно минимум 2 блока!',
    'piece_workshop_mode_count': '{count} режимов',
    'piece_workshop_modes_note_none': 'Примечание: Режимы не выбраны — фигура не появится в игре.',
    'piece_workshop_modes_note_selected': 'Примечание: Эта фигура появится в выбранных режимах.',
    'piece_workshop_modes_title': 'РЕЖИМЫ',
    'piece_workshop_modes_updated': 'Режимы обновлены',
    'piece_workshop_no_modes': 'Нет режимов',
    'piece_workshop_no_pieces': 'Фигур пока нет',
    'piece_workshop_palette_title': 'ЦВЕТА',
    'piece_workshop_piece_count': '{count} фигур',
    'piece_workshop_piece_deleted': 'Фигура удалена',
    'piece_workshop_piece_saved': 'Новая фигура сохранена!',
    'piece_workshop_piece_updated': 'Фигура обновлена!',
    'piece_workshop_save_button': '{modifier}+S : Сохранить',
    'piece_workshop_saved_pieces_title': '📐 СОХРАНЁННЫЕ ФИГУРЫ',
    'piece_workshop_showcase_desc': 'Создайте свои фигуры!',
    'piece_workshop_tip': 'Макс. {max_blocks} блоков | Блоки должны быть соединены | {modifier}+S: Сохранить',
    'piece_workshop_title': 'МАСТЕРСКАЯ ФИГУР',

    # --- ИГРОК ---
    'play_tutorial': 'Обучение',
    'player_1': 'Игрок 1',
    'player_2': 'Игрок 2',

    # --- PVP ---
    'pvp_duration_range': 'Можно установить от 1 до 10 минут',
    'pvp_endless': 'Бесконечный',
    'pvp_endless_desc': 'Без ограничения времени — побеждает тот, кто выживет',
    'pvp_enter_confirm': 'Нажмите Enter для подтверждения',
    'pvp_enter_name': 'Введите имя...',
    'pvp_match_duration': 'Длительность матча:',
    'pvp_match_mode': 'Режим матча:',
    'pvp_match_settings': 'НАСТРОЙКИ МАТЧА',
    'pvp_max_chars': 'До 12 символов',
    'pvp_player1_wasd': 'Игрок 1 — WASD',
    'pvp_player2_arrows': 'Игрок 2 — Стрелки',
    'pvp_player_profiles': 'ПРОФИЛИ ИГРОКОВ',
    'pvp_restart': 'Рестарт',
    'pvp_start': 'НАЧАТЬ',
    'pvp_subtitle_duration': 'Установите длительность матча (1–10 минут)',
    'pvp_subtitle_mode': 'Выберите режим матча: По времени или Бесконечный',
    'pvp_subtitle_names': 'Введите ники перед ретро-дуэлью',
    'pvp_time_up': 'ВРЕМЯ ВЫШЛО',
    'pvp_timed': 'По времени',
    'pvp_timed_desc': 'Побеждает тот, кто очистит больше линий за время',
    'pvp_title_names': 'PVP — ИМЕНА ИГРОКОВ',
    'pvp_title_settings': 'PVP — НАСТРОЙКИ МАТЧА',
    'pvp_top_out': 'ПЕРЕПОЛНЕНИЕ',

    # --- ВЫХОД ИЗ ИГРЫ ---
    'quit_confirm_message': 'Текущая игра завершится и вы вернётесь в главное меню. Несохранённый прогресс может быть потерян.',
    'quit_confirm_no_label': 'Отмена',
    'quit_confirm_select_hint': 'Выбор: Мышью или клавиатурой',
    'quit_confirm_title': 'Вернуться в главное меню?',
    'quit_confirm_yes_label': 'Да',

    # --- РАЗНОЕ ---
    'remaining_tries': 'Осталось попыток: {}/{}',
    'saved_profile': 'Профиль сохранён: {}',
    'select_user_hint': 'Выберите пользователя!',
    'opening_gmail': 'Открываем Gmail...',
    'opening_instagram': 'Открываем Instagram...',

    # --- НАСТРОЙКИ: ВКЛАДКИ ---
    'settings_tab_audio': 'ЗВУК',
    'settings_tab_controls': 'УПРАВЛЕНИЕ',
    'settings_tab_customize': 'ОФОРМЛЕНИЕ',
    'settings_tab_display': 'ЭКРАН',
    'settings_tab_game': 'ИГРА',
    'settings_tab_other': 'ПРОЧЕЕ',

    # --- НАСТРОЙКИ: РАЗДЕЛЫ ---
    'settings_section_blocks': 'БЛОКИ',
    'settings_section_developer': 'РАЗРАБОТЧИК',
    'settings_section_gameplay': 'ГЕЙМПЛЕЙ',
    'settings_section_general': 'ОБЩИЕ',
    'settings_section_mode_music': 'МУЗЫКА РЕЖИМОВ',
    'settings_section_music': 'МУЗЫКА',
    'settings_section_screen': 'ЭКРАН',
    'settings_section_sound_effects': 'ЗВУКОВЫЕ ЭФФЕКТЫ',
    'settings_section_system': 'СИСТЕМА',
    'settings_section_visual': 'ВИЗУАЛЬНЫЕ',

    # --- НАСТРОЙКИ: ЭЛЕМЕНТЫ ---
    'settings_block_styles_hint': 'ENTER : Настроить цвета и PNG',
    'settings_controls_hint': 'ENTER : Настроить клавиши',
    'settings_das_delay': 'Задержка DAS',
    'settings_das_repeat': 'Повтор DAS',
    'settings_gameplay_hint': 'ENTER : Настройки DAS и скорости',
    'settings_piece_workshop_hint': 'ENTER : Открыть мастерскую',
    'settings_soft_drop_speed': 'Скорость мягкого сброса',
    'settings_tracks_custom': '{count} пользовательских',
    'settings_tracks_default': 'По умолчанию',
    'soft_drop_speed': 'Скорость мягкого сброса',

    # --- СКИНЫ РЕЖИМОВ ---
    'skin_cascade_subtitle': 'Цепные взрывы линий',
    'skin_cascade_title': 'ВОЛНА КАСКАДА',
    'skin_classic_subtitle': 'Неоновое поле для одиночной игры',
    'skin_classic_title': 'КЛАССИЧЕСКИЙ РЕЖИМ',
    'skin_daily_subtitle': 'Сегодняшнее испытание',
    'skin_daily_title': 'ЕЖЕДНЕВНАЯ МИССИЯ',
    'skin_mystery_subtitle': 'Каждая карта — сюрприз',
    'skin_mystery_title': 'МАСТЕРСТВО КАРТ',
    'skin_pvp_subtitle': 'Ретро-дуэль один на один',
    'skin_pvp_title': 'АРЕНА PVP',
    'skin_sprint_subtitle': 'Очистите 40 линий быстро!',
    'skin_sprint_title': 'СПРИНТ-РЫВОК',
    'skin_survival_subtitle': 'Берегите жизни, ускоряйтесь!',
    'skin_survival_title': 'ТРЕВОГА ВЫЖИВАНИЯ',
    'skin_tetris2_subtitle': 'Доп. фигуры, доп. хаос',
    'skin_tetris2_title': 'QUADRIX EXTRA',
    'skin_tutorial_subtitle': 'Пошаговое обучение',
    'skin_tutorial_title': 'ОБУЧЕНИЕ',
    'skin_ultra_subtitle': '2 минуты — макс. очки',
    'skin_ultra_title': 'УЛЬТРА-БЛИЦ',
    'skin_wide_subtitle': '15 колонок широкого действия',
    'skin_wide_title': 'ШИРОКАЯ АРЕНА',
    'skin_zen_subtitle': 'Бесконечный режим релаксации',
    'skin_zen_title': 'САД ДЗЕН',

    # --- ПРОПУСК / SOS ---
    'skip_tutorial': 'Пропустить',
    'sos_email_subject': 'Quadrix — SOS / Обратная связь',
    'sos_instagram': 'Instagram',
    'sos_mail': 'Отправить письмо (Gmail)',
    'splash_press_enter': 'Нажмите Enter для продолжения',

    # --- СПРИНТ ---
    'sprint_congrats_title': 'ПОЗДРАВЛЯЕМ!',
    'sprint_finish_message': 'Вы очистили {lines} линий за {time} секунд!',
    'sprint_target_hint': 'Очистите {lines} линий быстро!',

    # --- ВЫЖИВАНИЕ ---
    'survival_panel_active_infection': 'АКТИВНАЯ ИНФЕКЦИЯ',
    'survival_panel_antivirus': 'АНТИВИРУС',
    'survival_panel_consumed': 'ПОГЛОЩЁННЫЕ БЛОКИ',
    'survival_panel_points_remaining': 'Осталось {points} очков',
    'survival_panel_ready': 'ГОТОВО!',
    'survival_panel_time_left': 'ОСТАЛОСЬ ВРЕМЕНИ',
    'survival_panel_virus_level': 'УРОВЕНЬ ВИРУСА',
    ...
    # --- QUADRIX ---
    'tetris': 'QUADRIX!',
    'tetris_count': 'Quadrix',
    'tetris_label': 'Quadrix',

    # --- ТЕМА ---
    'theme_label_fallback': 'Тема',
    'theme_picker_hint': '↑ ↓: Выбор  |  ENTER: Применить  |  ESC / Клик вне окна: Закрыть',

    # --- ТАЙМЕР ---
    'timer_label': 'ВРЕМЯ',
    'timer_resume': 'Продолжить (Пробел)',

    # --- ИТОГИ ---
    'total_games': 'Всего игр',
    'total_lines': 'Всего линий',
    'total_score': 'Общий счёт',
    'total_stars': 'Всего звёзд',
    'total_tetrises': 'Количество Quadrix',

    # --- ТРЕКИ ---
    'track_custom_fallback': 'Пользовательский трек',
    'track_default_label': 'По умолчанию (Игровой)',
    'track_file_prefix': 'Файл: {path}',
    'track_file_suffix': '(файл)',
    'track_summary': '{count} режимов настроено',
    'track_title': 'МУЗЫКА УРОВНЯ',
    'tracks': 'ТРЕКИ',

    # --- ОБУЧЕНИЕ ---
    'tutorial_step_1': 'Стрелками [ВЛЕВО] и [ВПРАВО] перемещайте фигуру.',
    'tutorial_step_2': 'Нажмите стрелку [ВВЕРХ] для поворота.',
    'tutorial_step_3': 'Удерживайте [ВНИЗ] для быстрого спуска (мягкий сброс).',
    'tutorial_step_4': 'Нажмите [ПРОБЕЛ] для мгновенной фиксации (быстрый сброс).',
    'tutorial_step_5': 'Заполняйте линии для их очистки! Поставьте I-фигуру в проём.',
    'tutorial_step_6': 'Нажмите [{hold_key}] для удержания фигуры.',
    'tutorial_step_done_generic': 'Шаг пройден!',
    'tutorial_step_done_hard_drop': 'Быстрый сброс освоен!',
    'tutorial_step_done_hold': 'Удержание освоено!',
    'tutorial_step_done_line_clear': 'Очистка линий освоена!',
    'tutorial_step_done_move': 'Движение освоено!',
    'tutorial_step_done_rotate': 'Поворот освоен!',
    'tutorial_step_done_soft_drop': 'Мягкий сброс освоен!',
    'tutorial_sub_finish': 'Нажмите ENTER',
    'tutorial_sub_hard_drop': 'Нажмите ПРОБЕЛ',
    'tutorial_sub_hold': 'Нажмите C',
    'tutorial_sub_line_clear': 'Очистите линию',
    'tutorial_sub_move': 'Влево: {left}/3  Вправо: {right}/3',
    'tutorial_sub_rotate': 'Поворот: {count}/{target}',
    'tutorial_sub_soft_drop': 'Удерживайте ВНИЗ ({progress}/{target})',
    'tutorial_success_1': 'Отлично!',
    'tutorial_success_2': 'Здорово!',
    'tutorial_success_3': 'Потрясающе!',
    'tutorial_success_4': 'Браво!',
    'tutorial_success_5': 'Поздравляем!',
    'tutorial_success_6': 'Успех!',
    'tutorial_success_hard_drop': 'Быстрый сброс удался!',
    'tutorial_success_hold': 'Удержание удалось!',
    'tutorial_success_line_clear': 'Линия очищена!',
    'tutorial_success_move_right': 'Движение вправо!',
    'tutorial_success_rotate': 'Отличный поворот!',
    'tutorial_tip_step_1': 'Сначала двигайте влево, затем вправо. Контроль на краю — ключевой навык.',
    'tutorial_tip_step_2': 'Оцените зазор перед поворотом. Ранний поворот уменьшает ошибки.',
    'tutorial_tip_step_3': 'Используйте мягкий сброс короткими нажатиями для точного размещения.',
    'tutorial_tip_step_4': 'Быстрый сброс нельзя отменить. Используйте, когда место приземления ясно.',
    'tutorial_tip_step_5': 'Закройте проём одним движением и сосредоточьтесь на очистке линии.',
    'tutorial_tip_step_6': 'Используйте удержание, чтобы отложить неудобную фигуру.',
    'tutorial_tip_step_7': 'Основы пройдены. Держите ритм и аккуратно размещайте фигуры.',
    'tutorial_tip_title': 'СОВЕТ',
    'tutorial_welcome_complete': 'Поздравляем! Вы прошли обучение!',
    'tutorial_welcome_hard_drop': 'Давайте освоим быстрый сброс!',
    'tutorial_welcome_hold': 'Изучим удержание!',
    'tutorial_welcome_line_clear': 'Время очистить линию!',
    'tutorial_welcome_move': 'Изучим управление движением!',
    'tutorial_welcome_rotate': 'Теперь научимся поворачивать фигуры!',
    'tutorial_welcome_soft_drop': 'Попробуем мягкий сброс!',

    # --- УЛЬТРА ---
    'ultra_final_score': 'Ваш итоговый счёт: {score}',
    'ultra_played_time': 'Время игры: {seconds} сек.',
    'ultra_remaining_label': '⏳ ОСТАЛОСЬ',
    'ultra_time_limit_hint': 'Лимит: 2 минуты!',

    # --- ПОЛЬЗОВАТЕЛЬ / ПРОФИЛЬ ---
    'user_account_info': 'Информация о пользователе',
    'user_action_back_esc': 'Назад (ESC)',
    'user_action_create': 'Создать (Enter)',
    'user_action_delete_profile': 'DEL : Удалить профиль',
    'user_action_edit': 'Редактировать',
    'user_action_edit_profile': 'ENTER : Редактировать профиль',
    'user_action_save': 'Сохранить (Enter)',
    'user_active': 'Активен',
    'user_adventure_hint': 'Выберите аватар, введите имя и начните!',
    'user_avatar_select': 'Выбор аватара',
    'user_avatar_updated': 'Аватар обновлён!',
    'user_bio': 'Биография',
    'user_control_change_field': 'Сменить поле',
    'user_control_change_value': 'Изменить значение',
    'user_control_custom_avatar': 'Свой аватар',
    'user_create_empty': 'Имя пользователя не может быть пустым!',
    'user_create_exists': 'Такое имя уже существует!',
    'user_create_hint': 'Создайте профиль для сохранения прогресса',
    'user_create_new': 'Создать пользователя',
    'user_create_success': 'Пользователь создан!',
    'user_create_too_long': 'Слишком длинное имя! (Макс. 20 символов)',
    'user_custom_image': 'Своё изображение выбрано',
    'user_delete_confirm_line1': 'Удалить пользователя «{username}»',
    'user_delete_confirm_line2': 'Вы уверены, что хотите удалить навсегда?',
    'user_delete_not_found': 'Пользователь не найден!',
    'user_delete_warning': 'Все достижения и результаты будут удалены!',
    'user_edit_profile_title': 'РЕДАКТИРОВАНИЕ ПРОФИЛЯ',
    'user_field_avatar': 'Аватар',
    'user_field_bio': 'Биография',
    'user_field_color': 'Цвет',
    'user_field_empty': '(Пусто)',
    'user_field_favorite_mode': 'Любимый режим',
    'user_held_count_label': 'Удержано: {count} раз',
    'user_help_avatar_count': '{count} аватаров доступно',
    'user_help_avatar_custom': 'Нажмите C для загрузки своего изображения',
    'user_help_avatar_switch': 'Влево/Вправо для смены аватара',
    'user_help_bio_count': '{count}/{max} символов',
    'user_help_bio_input': 'Набирайте или используйте BACKSPACE',
    'user_help_color_count': '{count} цветов доступно',
    'user_help_color_switch': 'Влево/Вправо для смены цвета',
    'user_help_mode_count': '{count} режимов',
    'user_help_mode_switch': 'Влево/Вправо для выбора любимого режима',
    'user_helper_create': 'Выберите аватар, введите имя и начните.',
    'user_helper_edit': 'Обновите аватар и сохраните.',
    'user_hint_create': 'Нажмите ENTER для создания, ESC — назад.',
    'user_hint_save': 'Нажмите ENTER для сохранения, ESC — отмена.',
    'user_last_played': 'Последняя игра',
    'user_locked': 'Заблокировано',
    'user_management': 'Управление пользователями',
    'user_mode_games': '{games} игр',
    'user_mode_stats': 'Статистика режимов',
    'user_most_held_piece_title': 'Самая удерживаемая фигура',
    'user_name_locked': 'Это имя нельзя изменить',
    'user_never_played': 'Ещё не играл',
    'user_new_profile': 'Создайте нового пользователя.',
    'user_new_user_title': 'НОВЫЙ ПОЛЬЗОВАТЕЛЬ',
    'user_no': 'N — Нет',
    'user_no_active': 'Нет активного пользователя',
    'user_no_bio': 'Биография не добавлена',
    'user_no_games': 'Игр ещё не было',
    'user_no_storage_data': 'Данных хранилища нет.',
    'user_not_created': 'Пользователи не созданы',
    'user_panel_create': 'Создать профиль',
    'user_panel_edit': 'Редактировать профиль',
    'user_piece_label': 'Фигура: {piece}',
    'user_profile_info': 'Информация о профиле',
    'user_profile_saved': 'Профиль сохранён!',
    'user_profile_summary': 'Сводка профиля',
    'user_profiles': 'Профили',
    'user_select_not_found': 'Пользователь не найден!',
    'user_select_title': 'ВЫБОР ПОЛЬЗОВАТЕЛЯ',
    'user_selected': '{username} выбран как активный!',
    'user_set_active': 'Сделать активным',
    'user_set_active_message': '{username} теперь активен',
    'user_start_hint': 'Создайте профиль слева, чтобы начать.',
    'user_stats_summary': '{games} игр  •  {score} очков  •  {lines} линий',
    'user_username': 'Имя пользователя',
    'user_username_placeholder': 'Введите имя...',
    'user_validation_empty': 'Имя пользователя не может быть пустым.',
    'user_validation_exists': 'Такое имя уже существует.',
    'user_validation_invalid_chars': 'Только буквы, цифры, пробелы и _ - .',
    'user_validation_suggestion': 'Предложение: {suggestion}',
    'user_validation_too_long': 'Слишком длинное имя (макс. 20 символов).',
    'user_validation_too_short': 'Слишком короткое имя (мин. 2 символа).',
    'user_validation_trailing_space': 'Концевые пробелы запрещены.',
    'user_will_delete': 'Пользователь будет удалён!',
    'user_yes': 'Y — Да',

    # --- ДЗЕН ---
    'zen_auto_clear_desc': 'Сколько рядов очищать при заполнении поля?',
    'zen_auto_clear_title': 'НАСТРОЙКИ АВТО-ОЧИСТКИ',
    'zen_message_full_clear': 'ПОЛНАЯ ОЧИСТКА',
    'zen_message_full_clear_fallback': 'ПОЛНАЯ ОЧИСТКА (недостаточно места)',
    'zen_message_lines': '{lines} ЛИНИЙ!',
    'zen_message_relax_bonus': 'Бонус релакса! +{bonus}',
    'zen_message_rows_cleared': '{rows} ЛИНИЙ ОЧИЩЕНО',
    'zen_message_tetris': 'НЕВЕРОЯТНЫЙ QUADRIX!',
    'zen_panel_auto_clear': 'Авто-очистка',
    'zen_panel_bonus': 'Бонус',
    'zen_panel_penalty': 'Штраф',
    'zen_panel_time': 'Время',

    # --- GAMEPAD KART İSİMLERİ (Ek) ---
    'gp_card_bomb': 'Мастер бомб',
    'gp_card_ghost': 'Призрачный блок',
    'gp_card_hammer': 'Молот',
    'gp_card_phase_shift': 'Сдвиг фазы',
    'gp_card_rewind': 'Перемотка',
    'gp_card_sniper': 'Снайпер',
...
# Gerçek RU çevirilerini TRANSLATIONS'a uygula
for _ru_key, _ru_val in _RU_TRANSLATIONS.items():
    if _ru_key in TRANSLATIONS:
        TRANSLATIONS[_ru_key]['ru'] = _ru_val
