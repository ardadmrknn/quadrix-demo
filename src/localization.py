...
TRANSLATIONS = {
    ...
    'block_style_footer_line2_block': {
        ...
        'ru': 'TAB: Переключить режим | Мышь: Прокрутка | ESC: Назад | F12: Полный экран',
    ...
    'block_style_footer_line2_custom': {
        ...
        'ru': 'TAB: Переключить режим ({theme}) | Мышь: Прокрутка | ESC: Назад | F12: Полный экран',
