...
print('Start: board.level', mode.board.level, 'pending_level_ups', mode.pending_level_ups, 'progress', mode.card_manager.progress)
mode.board.lines_cleared = 4
mode.board.level = (mode.board.lines_cleared // 5) + 1
# Now simulate a line clear that increases both board.lines_cleared and manager progress
mode.board.lines_cleared += 1
mode.board.level = (mode.board.lines_cleared // 5) + 1
print('After line add: board.level', mode.board.level)
mode.card_manager.notify_lines_cleared(1)
print('After notify: board.level', mode.board.level, 'pending_level_ups', mode.pending_level_ups, 'progress', mode.card_manager.progress)
# Run update that should open overlay if pending
mode.update(16)
