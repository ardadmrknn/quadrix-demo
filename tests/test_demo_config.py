...
def test_write_demo_config_generates_demo_and_full_variants(tmp_path) -> None:
    ...
    assert 'DEMO_MYSTERY_SCORE_CAP = 1000000' in demo_source
    ...
    assert 'DEMO_MYSTERY_SCORE_CAP = 1000000' in full_source
...
def test_generated_demo_config_applies_demo_app_name(tmp_path) -> None:
    ...
    assert demo_config.DEMO_MYSTERY_SCORE_CAP == 1000000
